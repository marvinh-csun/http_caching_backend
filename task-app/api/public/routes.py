...
import time
api_public_blueprint = Blueprint('api_public_blueprint', __name__ )
import hmac
import hashlib
import logging

@api_public_blueprint.route("")
def index():
...
@api_public_blueprint.route("/last")
def last():
    last_statement = text(
        """
...
@api_public_blueprint.route("/search")
def search():
